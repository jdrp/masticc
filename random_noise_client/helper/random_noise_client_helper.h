 ...
 */
#ifndef RANDOM_NOISE_HELPER_H
#define RANDOM_NOISE_HELPER_H
 ...
 */
class RandomNoiseClientHelper
{
  public:
    /**
     * Create RandomNoiseClientHelper which will make life easier for people trying
     ...
     */
    RandomNoiseClientHelper(Address ip, uint16_t port);
    /**
     * Create RandomNoiseClientHelper which will make life easier for people trying
     * to set up simulations with echos. Use this variant with addresses that do
     ...
     */
    RandomNoiseClientHelper(Address addr);
    ...
    /**
     * Given a pointer to a RandomNoiseClient application, set the data fill of the
     ...
     *
     * \param app Smart pointer to the application (real type must be RandomNoiseClient).
     ...
     *
     * \param node The Ptr<Node> on which to create the RandomNoiseClientApplication.
     *
     ...
     *
     * \param nodeName The name of the node on which to create the RandomNoiseClientApplication
     *
     * \returns An ApplicationContainer that holds a Ptr<Application> to the
     *          application created
     */
  ...
  private:
    /**
     * Install an ns3::RandomNoiseClient on the node configured with all the
     * attributes set with SetAttribute.
     *
     * \param node The node on which an RandomNoiseClient will be installed.
