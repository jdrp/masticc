...
cmd.AddValue("nClients", "Number of clientes connected to R1", nClients)
...
# client star network
pointToPoint.SetDeviceAttribute("DataRate", ns.core.StringValue(f"{accessDelay.value}Mbps"))
pointToPoint.SetChannelAttribute("Delay", ns.core.StringValue(f"{accessRate.value}ms"))
